...
{block name=title}Contattaci{/block}
{block name=body}
                        ...
                        <div class="row mb-5">
                            <div class="col-md-3">
                                <div class="dbox w-100 text-center">
                                    ...
                                    <div class="text">
                                        <p><span>Indirizzo:</span>Via {$restaurant->getAddress()->getStreet()} {$restaurant->getAddress()->getHomeNumber()}, {$restaurant->getAddress()->getCity()}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="dbox w-100 text-center">
                                    ...
                                    <div class="text">
                                        <p><span>Telefono:</span> <a href="tel://1234567920">{$restaurant->getPhone()}</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
